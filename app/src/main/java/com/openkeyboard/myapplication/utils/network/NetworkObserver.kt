...
class NetworkConnectivityObserver( private val context: Context): ConnectivityObserver {
    ...
    override fun observe(): Flow<ConnectivityObserver.Status> {
        return callbackFlow {
            ...
            val initialStatus = getInitialStatus()
            launch { send(initialStatus) }

            // This is the callback that will be triggered on network changes
    ...
    private fun getInitialStatus(): ConnectivityObserver.Status {
